...
### 1. Controle de Inspeção de Peças (`relatoriopecasimpar`)
...
### 2. Simulador de Caixa Eletrônico / Sistema Bancário (`prototipocaixa`)
...
### 3. Calculadora de IMC (`calculadora_imc`)
...
### 4. Calculadora de Despesa de Combustível (`despesa_combustivel`)
